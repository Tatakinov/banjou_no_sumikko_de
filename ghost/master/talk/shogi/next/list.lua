...
files = {
  ...
  {
    filename = Path.join("talk", "shogi", "next", "next024.kif"),
    difficulty  = 3,
  },
  {
    filename = Path.join("talk", "shogi", "next", "next025.kif"),
    difficulty  = 3,
  },
  {
    filename = Path.join("talk", "shogi", "next", "next026.kif"),
    difficulty  = 2,
  },
  {
    filename = Path.join("talk", "shogi", "next", "next027.kif"),
    difficulty  = 4,
  },
  {
    filename = Path.join("talk", "shogi", "next", "next028.kif"),
    difficulty  = 3,
  },
  {
    filename = Path.join("talk", "shogi", "next", "next029.kif"),
    difficulty  = 4,
  },
  {
    filename = Path.join("talk", "shogi", "next", "next030.kif"),
    difficulty  = 3,
  },
  {
    filename = Path.join("talk", "shogi", "next", "next031.kif"),
    difficulty  = 2,
  },
  {
    filename = Path.join("talk", "shogi", "next", "next032.kif"),
    difficulty  = 4,
  },
  {
    filename = Path.join("talk", "shogi", "next", "next033.kif"),
    difficulty  = 2,
  },
  {
    filename = Path.join("talk", "shogi", "next", "next034.kif"),
    difficulty  = 3,
  },
  {
    filename = Path.join("talk", "shogi", "next", "next035.kif"),
    difficulty  = 4,
  },
  {
    filename = Path.join("talk", "shogi", "next", "next036.kif"),
    difficulty  = 4,
  },
}
